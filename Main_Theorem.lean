...
--These lines set up the context in which the main theorem will be proved. Essentially they say that V is a finite set of vertices and K is the complete graph on those vertices (and then the graphs considered in the theorem will be subgraphs of K).
universe u
